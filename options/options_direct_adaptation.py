...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser(description="arguments for Direct Adaptation")
    ...
    # data info
    parser.add_argument('--batch_size', type=int, default=64, help='batch size of GA')
    parser.add_argument('--num_workers', type=int, default=4, help='number of workers')
    parser.add_argument('--data_folder', type=str, default='./shapeNetData', help='directory to data')
    parser.add_argument('--cls', type=str, default='02828884',
...
#     parser.add_argument('--p_gen_path', type=str, default='./model/program_generator_GA_bench.t7',
#     parser.add_argument('--p_gen_path', type=str, default='./model/program_generator.t7',
    parser.add_argument('--p_gen_path', type=str, default='./model/ckpts_GA_02828884/ckpt_epoch_60.t7',
                        help='path to the program generator')
...
def parse():
    ...
    opt.synset_p = os.path.join(opt.data_folder,opt.cls)

    if opt.cls in ['chair', 'table']:
        pass
    elif opt.cls in ['sofa', 'cabinet', 'bench', '02828884']:
        opt.epochs = max(80, opt.epochs)
    elif opt.cls in ['bed']:
